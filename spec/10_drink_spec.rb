...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:dr_pepper) { described_class.new('dr pepper') }

      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(dr_pepper.type).to eq('dr pepper') 
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(dr_pepper.ounces).to eq(16) 
  ...
  describe '#full?' do
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:tea) { described_class.new('tea', 6) }
