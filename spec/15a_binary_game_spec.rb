...
describe BinaryGame do
  ...
  # context blocks.
  subject(:game_verify_input) { described_class.new(1, 20) }
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        valid_input = 1
        verified_input = game_verify_input.verify_input(1, 2, valid_input)
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        invalid_input = 3
        verified_input = game_verify_input.verify_input(1, 2, invalid_input)
